(function () {
    ...
    assessmentButton.onclick = () => {
        const userName = userNameInput.value;(function () {
    'use strict';
    const userNameInput = document.getElementById('user-name');
    const assessmentButton = document.getElementById('assessment');
    const resultDivided = document.getElementById('result-area');
    ...
    assessmentButton.onclick = () => {
        ...
        if (userName.length === 0) { //名前がからの時は処理を終了する。「ガード句」。returnは、値を返さなくても良い。処理を終了する。
            return;
        }
    ...
    userNameInput.onkeydown = (event) => {
        ...
        // TODO ツイートエリアの作成
        // <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-text="hoge" data-hashtags="あなたのいいところ" data-show-count="false">Tweet</a>
    ...
    console.assert(
        assessment("田中") === assessment("田中"),
    "入力が同じならば同じ診断結果が出るテストが失敗している。"
    )
